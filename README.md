...
In contrast to the overly simple "question" solution, selecting each requirement manually is time consuming and requires strong knowledge of the EN 301 549 standard. A "wizard" style was chosen as a middle-ground between questions and the manual selection, inspired by the [GSA Accessibility Requirements Tool](https://a11y.canada.ca/en/procurement/).
